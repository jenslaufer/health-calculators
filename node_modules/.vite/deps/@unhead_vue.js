import { _ as walkResolver, a as useHeadSafe, c as useServerHeadSafe, d as VueResolver, f as createUnhead, i as useHead, l as useServerSeoMeta, n as headSymbol, o as useSeoMeta, r as injectHead, s as useServerHead, t as VueHeadMixin, y as ScriptNetworkEvents } from "./vue.BM998iwd-DeXzVrDA.js";
import { Ft as onMounted, Kn as ref, Rn as isRef, Vn as onScopeDispose, gn as watch, ut as getCurrentInstance } from "./vue.runtime.esm-bundler-G-QkqzdF.js";
//#region node_modules/unhead/dist/shared/unhead.BnoAbrHA.mjs
	...
	const script = {
		...
		setupTriggerHandler(trigger) {
			...
			if ((typeof trigger === "undefined" || trigger === "client") && !head.ssr || trigger === "server") script.load();
				...
				const idx = script._triggerPromises.push(Promise.race([trigger.then((v) => typeof v === "undefined" || v ? script.load : void 0), abortPromise]).catch(() => {}).then((res) => {
					res?.();
				}).finally(() => {
...
//#endregion
//#region node_modules/@unhead/vue/dist/shared/vue.CVf9mpRR.mjs
...
function useScript(_input, _options) {
	...
	head._scriptStatusWatcher = head._scriptStatusWatcher || head.hooks.hook("script:updated", ({ script: s }) => {
		if (s._statusRef) s._statusRef.value = s.status;
	});
...
var unheadVueComposablesImports = { "@unhead/vue": [
	"injectHead",
	"useHead",
	"useSeoMeta",
	"useHeadSafe",
...
var createHeadCore = createUnhead;
//#endregion
