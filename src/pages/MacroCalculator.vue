  ...
  <div class="min-h-screen bg-stone-50">
    <div class="bg-gradient-to-br from-[#131836] to-[#1a2248] py-8 px-4">
      <div class="max-w-3xl mx-auto">
        ...
        <h1 class="text-4xl font-bold text-white tracking-tight leading-tight mb-2">Macro Calculator</h1>
        <p class="text-stone-400">Calculate your ideal protein, carb, and fat targets based on your goals.</p>
      </div>
    </div>
    ...
    <div class="max-w-3xl mx-auto px-4 py-8">
      <div class="bg-white rounded-xl shadow-sm border border-stone-200 p-6 mb-6">
        ...
        <div class="grid grid-cols-2 gap-4 mb-4">
          <div>
            <label class="block text-xs font-semibold text-stone-500 tracking-wide uppercase mb-1.5">Age</label>
            <input
              v-model.number="age"
              type="number"
              placeholder="30"
        ...
        <!-- Activity level -->
        <div class="mb-4">
          <label class="block text-xs font-semibold text-stone-500 tracking-wide uppercase mb-1.5">Activity Level</label>
        ...
        <!-- Goal -->
        <div class="mb-6">
          <label class="block text-xs font-semibold text-stone-500 tracking-wide uppercase mb-1.5">Goal</label>
          <div class="flex gap-2">
            <button
              v-for="g in goals"
              :key="g.key"
