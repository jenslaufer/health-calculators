        ...
        <div class="flex items-start justify-between border-b border-stone-100 pb-3.5">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs text-stone-400 mt-0.5">Besonders kritisch bei Fruchtbarkeit und Knochendichte</p>
            </div>
          </div>
        ...
        <div class="flex items-start justify-between border-b border-stone-100 pb-3.5">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs text-stone-400 mt-0.5">Gilt für erwachsene Frauen bis 65 Jahre (DGE)</p>
            </div>
          </div>
        ...
        <div class="flex items-start justify-between border-b border-stone-100 pb-3.5">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs text-stone-400 mt-0.5">Peripheres Fett bei Frauen weniger riskant als viszerales</p>
            </div>
          </div>
        ...
        <div class="flex items-start justify-between">
          <div class="flex items-center gap-3">
            ...
            <div>
              ...
              <p class="text-xs text-stone-400 mt-0.5">Erhöhtes kardiovaskuläres und metabolisches Risiko</p>
            </div>
          </div>
